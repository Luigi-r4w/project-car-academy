...
public class MotoView {
	...
	public Integer getMoto_id() {
		return moto_id;
	}
	public void setMoto_id(Integer moto_id) {
	...
	public MotoView(Integer moto_id, Integer cc, String modello, Integer numero_ruote, String targa_valore,
			String marca_nome, String colore_nome, String categoria_nome, String alimentazione_nome,
	...
	public String toString() {
		return "MotoView [moto_id=" + moto_id + ", cc=" + cc + ", modello=" + modello + ", numero_ruote=" + numero_ruote
				+ ", targa_valore=" + targa_valore + ", marca_nome=" + marca_nome + ", colore_nome=" + colore_nome
				+ ", categoria_nome=" + categoria_nome + ", alimentazione_nome=" + alimentazione_nome
